...
export async function truncateAll() {
  await testDb.execute(sql`TRUNCATE TABLE payments, order_events, order_item_options, order_items, orders, customer_addresses, drivers, option_variation_prices, options, option_groups, products, product_categories, refresh_tokens, auth_providers, stores, users CASCADE`)
}
